...
const validarContrasena = ()=>{
    if(form.password.value=="" || form.password.value.length<8 || !validarValorContrasena(form.password.value)){
...
const validarRepetirContrasena = ()=>{
    if(form.repeatPassword.value=="" || form.repeatPassword.value!=form.password.value){
...
form.addEventListener("submit", (e)=>{
    ...
    if (validarNombre() && validarApellido() && validarUser() && validarEmail() && validarPais() && validarCel() && validarContrasena() && validarRepetirContrasena() && validarFoto()) {
        form.submit()
    }
})
